...
import Haskode.Tools
    ( defaultRegistry,
      ...
      truncateText,
      Tool(toolExecute),
      TraversalStats(tsOutsideRoot, TraversalStats, tsSkippedLarge,
                     tsSkippedUnreadable, tsIgnoredByAgent, tsRevisitedDirs),
      TruncResult(truncDidTruncate, truncReturnedLength, truncDropped,
                  truncText, truncOriginalLength) )
...
import qualified Data.Text as T
    ( Text, isInfixOf, length, replicate, splitOn, take, unpack )
-- ---------------------------------------------------------------------------
